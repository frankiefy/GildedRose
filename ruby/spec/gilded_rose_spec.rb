...
describe GildedRose do
  ...
  describe "#update_quality" do
    ...
    context "Regular Items & special item's normal charactersitics" do
      ...
      it 'quality decreases over time' do
      ...
      it 'sell_in decreases over time' do
        items = [Item.new("foo", 10, 5)]
        GildedRose.new(items).update_quality
    ...
    context "Special Items" do
      ...
      context "Sulfuras" do
        ...
        it 'sell_in does not decrease over time' do
          items = [Item.new("Sulfuras, Hand of Ragnaros", 10, 5)]
          GildedRose.new(items).update_quality
          expect(items[0].sell_in).to eq 10
        end

        it 'quality does not decrease over time' do
          items = [Item.new("Sulfuras, Hand of Ragnaros", 10, 5)]
          GildedRose.new(items).update_quality
      ...
      context "Backstage Passes" do
        ...
        it 'quality increases by 1 over time' do
      ...
      context "Aged Brie" do
        ...
        it 'quality increases over time' do
